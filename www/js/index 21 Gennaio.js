			...
			localStorage.setItem("idprofilo", id);
             ...
             success:function(result){
                 ...
                 $.each(result, function(i,item){
                    ...
                    $("#profiloman").html("<div id='frecciaback' class='frecciasx'><a id='ritorna'><img src='img/indietro_over.png' height='40px'></a></div><img src='http://msop.it/public/"+item.foto+"' width='100%' class='pippo22'>")
	...
	$(document).on("touchstart", "#modifica", function(e){
		...
		function listafeste(){
			...
			$.ajax({
				   ...
				   //myScroll = new IScroll('#wrapper2', { click: true });
