...
var app = {
	...
	$(document).on("touchstart", "#indietro", function(e){
	   ...
	   var swiper = new Swiper('.swiper-container');
		...
		$(document).on("touchstart", "#cancellagalleria", function(e){
                       
            window.location.href = "cancellagalleria.html";
 ...
 $(document).on("tap", "#play", function(e){
  ...
  $(document).on("tap", "#moulin", function(e){
	...
	$(document).on("tap", "#disco", function(e){
	   ...
	   $("#anteprimaparty2").html("<br><table align='center'><tr><td align='left'><font style='background-color:#000' color='#00ffff' class='AntonioFontBold' size='5'>&nbsp;ORGANIZATION:</font><font style='background-color:#000' color='#fff' class='AntonioFontBold' size='5'> MIX&nbsp;</font><br><font style='background-color:#000' color='#00ffff' class='AntonioFontBold' size='5'>&nbsp;CATEGORY:</font><font style='background-color:#000' color='#fff' class='AntonioFontBold' size='5'> SEXY - MEETING - FUN&nbsp;</font><br><font style='background-color:#000' color='#00ffff' class='AntonioFontBold' size='5'>&nbsp;LOCATION:</font><font style='background-color:#000' color='#fff' class='AntonioFontBold' size='5'> LOCAL &nbsp;</font></td></tr></table><br><table width='100%' ><tr bgcolor='#00ffff'><td width='100%' align='center'><b><font color='#000' class='AntonioFontBold' size='5' align='center'>DESCRIZIONE</font></b></td></tr><tr><td width='100%' align='center'><b><font color='#000' size='4' class='#'> Casa , locale , musica e divertimento!<br>Questo tipo di Private Party nasce per valorizzare il Pre-serata!<br>Magico momento decisamente alcolico che anticipa l'entrata in discoteca! Invita le persone con cui desideri ballare tutta la notte ma ricorda che la vera follia inizia da casa! <br>BALLA... SEI VIVO!<br> <div><center><img src='img/macchia.png' width='60px'></center></div> Home,local,music and entertainment!<br>This type of private party was created to valuate the pre-drinking! Magical and for sure alcoholic moment that anticipates entrance to the club!<br>Invite all people whom you want to dance, but remember that the real madness starts at home!<br> Dance.... You are alive! <br></font></b></td></tr></table>")
